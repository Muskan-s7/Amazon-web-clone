...
class Product {
  ...
  getPrice() {
    return `$${priceInCents(this.priceCents)}`;
  }
...
class Clothing extends Product {
  ...
  constructor(productDetails) {
    ...
    // super() calls the constructor of the class which is
    //  inherited i.e, constructor of the class Product
...
/*
Built in classes --> classes provided by language (already built in)
ex: Date()
const date = new Date(); //gives current date
console.log(date);
console.log(date.toLocaleTimeString()); //gives current time
*/

//*****note: can't load instructionsLink and warrantyLink,since we are using backend which does not contain
//instruction and warranty links as our products array does
...
export function loadProductsFetch() {
  //By default 'GET' the data from the given URL
  //when we call fetch it creates a promise which can be used add next step (usin .then())
